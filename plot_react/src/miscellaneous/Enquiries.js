import { Box, Button, Flex, FormControl, FormLabel, Heading, IconButton, Input, InputGroup, InputLeftElement, Link, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Stack, Text, Textarea, Tooltip, useClipboard, useColorModeValue, useDisclosure, useToast, VStack } from '@chakra-ui/react'
...
const Enquiries = () => {
 ...
 const[listingid,setListingid]=useState();
  const [data,setData]=useState([{message:"This apartment can be take on lease ",enquiryBy:"test user",EnquiryOnListing:"Royal villa",enquiryEmail:"testuser@gmail.com"}])
  ...
  const [enquiryData,setEnquiryData]=useState();
   ...
   useEffect(()=>{
    ...
    setListingid(location?.state._id);
...
const validateEmail = (email) => {
  ...
  if(!name || !email || !message){
    ...
    const enquiry = await ListingService.createEnquiry(loginToken,enquiryData,listingid);
    console.log(enquiry.data)
   if(enquiry.status === 200){
  toast({
      position: 'top-right',
       title:  enquiry.data.message,
       status: 'success',
       duration: 1000,
       isClosable: true,
     });
  ...
  return (
   ...
   <Flex
      ...
      <Box
        ...
        <Box>
          <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
            <Heading>Enquiry on listing {location.state.name}</Heading>
            ...
            <Stack
              ...
              {/* <Stack
                ...
                direction={{ base: 'row', md: 'column' }}>
                   ...
                   <Text >Review:{data.quantity} </Text>
      ...
      {enquiryData && <ItemPage data={enquiryData}></ItemPage> }
   </Sidebar>
