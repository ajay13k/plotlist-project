...
import ListingService from '../services/ListingService';
  const  ListingDetails = ({children , data})=> {
     ...
     const { isOpen, onOpen, onClose } = useDisclosure()
      ...
      setShow(listing.data)
      setKey(Object.keys(listing.data.metadata))
     }
     useEffect(()=>{
    ...
    return (
        <>
         <Text onClick={()=>{onOpen(); getListingById(); }}>{children}</Text>
        ...
        <SimpleGrid
          ...
          <Stack spacing={{ base: 6, md: 10 }}>
            ...
            <Button
              ...
              Owner : {show?.PostedUserid.first_name}
            </Button>
  
            <Stack direction="row" alignItems="center" justifyContent={'center'}>
              {/* <MdLocalShipping /> */}
              <Text>Reviews {show?.reviews.length}</Text>
              <StarIcon></StarIcon>
              <StarIcon></StarIcon>
              <StarIcon></StarIcon>
            </Stack>
